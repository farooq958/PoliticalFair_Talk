...
class PollView extends StatefulWidget {
  const PollView({
    ...
    this.heightBetweenTitleAndOptions = 4,
...
class _PollViewState extends State<PollView> {
  ...
  late PollOption? votedOption;
  // bool _isPostEnded = false;
  @override
  void initState() {
    hasPollEnded = widget.pollEnded;
    userHasVoted = widget.hasVoted;
    votedOption = (widget.hasVoted == false
        ? null
        : widget.pollOptions.firstWhere(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              onTap: () {
                                ...
                                //  pollProvider.updatePoll(widget.poll.pollId, , optionIndex)
                              },

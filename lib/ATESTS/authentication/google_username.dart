...
// class UsernameGoogle extends StatelessWidget {
//   @override
...
class CreateUsernameGoogle extends StatefulWidget {
  var durationInDay;
  CreateUsernameGoogle({Key? key, this.durationInDay}) : super(key: key);

  @override
  State<CreateUsernameGoogle> createState() => _CreateUsernameGoogleState();
}

class _CreateUsernameGoogleState extends State<CreateUsernameGoogle> {
